...
write_csv(stable_stress, paste("iter", 0,"_stable_stressed_summ.csv",sep=""))
write_csv(inc, paste("iter", "Neg1","_inconsistent_summ.csv",sep=""))
...
for (itNum in iters) {
 itNum
  ...
  write_csv(stable_stress, paste("iter", itNum,"_stable_stressed_summ.csv",sep=""))
  write_csv(inc, paste("iter", itNum-1,"_inconsistent_summ.csv",sep=""))
